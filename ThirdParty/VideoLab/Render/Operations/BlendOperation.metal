...
fragment half4 blendOperationFallbackFragment(SingleInputVertexIO fragmentInput [[stage_in]],
                                              texture2d<half> inputTexture [[texture(0)]],
                                              ...
                                              constant float& blendOpacity [[ buffer(2) ]])
{
    constexpr sampler quadSampler;
    half4 sourceColor = inputTexture.sample(quadSampler, fragmentInput.textureCoordinate);
    half4 backColor = backTexture.sample(quadSampler, fragmentInput.textureCoordinate);
